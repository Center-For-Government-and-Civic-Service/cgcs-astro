export interface Partner {
  ...
  logoDomain?: string;
  /** Local logo image path (e.g. '/images/partners/logo.png') — bypasses Clearbit */
  localLogo?: string;
  description?: string;
...
export const partners: Partner[] = [
  {
    ...
    description: 'ACM at ACC brings computing education and professional development to Austin Community College students.',
    size: 'sm',
    x: 12, y: 12,
  },
  {
    ...
    description: 'ACM Austin Chapter hosts meetups and talks for computing professionals and enthusiasts in the Austin area.',
    size: 'sm',
    x: 92, y: 35,
  },
  {
  ...
  },
  {
    ...
    description: 'ATX Design Jams brings designers together for collaborative design challenges and creative problem-solving.',
    size: 'sm',
    x: 38, y: 58,
  },
  {
  ...
  },
  {
    ...
    href: 'https://aimug.org/',
    localLogo: '/images/partners/aimug.png',
    description: 'Austin LangChain AIMUG is an AI Middleware Users Group helping members learn, connect, and build in the open.',
    size: 'lg',
    x: 72, y: 42,
  },
  {
